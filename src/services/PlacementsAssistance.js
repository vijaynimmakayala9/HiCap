                ...
                <Row className="align-items-center">
                    ...
                    <Col lg={6} className="order-lg-2 order-1">
                        ...
                        <p className="lead text-muted">
                            Our comprehensive placement program ensures you get opportunities with 
                            top employers matching your skills and aspirations.
                        </p>
                        <ul className="mb-4">
                    ...
                    <Col md={4}>
                        <Card className="h-100 shadow-sm border-0 card-hover-effect">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    Access to our network of 500+ companies actively hiring from our institute.
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={4}>
                        <Card className="h-100 shadow-sm border-0 card-hover-effect">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    Company-specific training based on your target employers' requirements.
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={4}>
                        <Card className="h-100 shadow-sm border-0 card-hover-effect">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    Track placement statistics and optimize your job search strategy.
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
