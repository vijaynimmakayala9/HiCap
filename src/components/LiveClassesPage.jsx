...
const LiveClassesPage = () => {
  ...
  const fetchLiveClasses = async () => {
    try {
      ...
      const res = await fetch(`https://backend-hicap.onrender.com/api/live-classes/user/${user.id}`);
      ...
      try {
        const fallbackRes = await fetch('https://backend-hicap.onrender.com/api/liveclass');
