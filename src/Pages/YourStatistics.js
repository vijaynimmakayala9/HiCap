...
const YourStatistics = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch courses
        const coursesResponse = await axios.get('https://api.techsterker.com/api/coursecontroller');
        ...
        // Fetch enrollments
        const enrollmentsResponse = await axios.get('https://api.techsterker.com/api/enrollments');
